package com.yh.yhandmlu.daily.fileEncode;
...
public class Demo {
    ...
    public static void main(String[] args) {
        try {
            ...
            String path = "/Users/yanghai/Downloads/yh-test-file/test.txt";
             ...
             */
            osw = new OutputStreamWriter(new FileOutputStream(path, true), "ISO8859_1");
            osw.write("他山之石，可以攻玉！！！");
            System.out.println("修改文件编码之后getEncoding：" + osw.getEncoding());
            osw.close();
            System.out.println(codeString(path));
